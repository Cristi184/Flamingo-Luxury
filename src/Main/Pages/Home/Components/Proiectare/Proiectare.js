...
const Proiectare = () => {
    ...
    const titlelist=['DESIGN STRUCTURAL ATENT PROIECTAT','CONCEPT ARHITECTURAL MODERN','INSTALAȚII EFICIENTE ȘI ESTETICE','INSTALAȚII EFICIENTE ȘI ESTETICE']
    ...
    return (
        <RouteComponents background = {Background} title = "Proiectare" >
        <ContainerProiectare>
            <ContainerRight title={titlelist[0]} paragraf = {paragraphList[0]} img = {Img1}/>
            <ContainerLeft title={titlelist[1]} paragraf = {paragraphList[1]} img = {Img2}/>
            <ContainerRight title={titlelist[2]} paragraf = {paragraphList[2]} img = {Img3}/>
            <ContainerLeft title={titlelist[3]} paragraf = {paragraphList[3]} img = {Img4}/>
